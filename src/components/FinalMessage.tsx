...
export const FinalMessage = () => {
  ...
  const resetLandingTransition = useGame((state) => state.resetLandingTransition);
        ...
        <div className={center({
          ...
          <motion.div
            ...
            className={css({
              ...
              borderRadius: "12px",
              border: "1px solid",
              borderColor: isSuccess ? "rgba(52, 211, 153, 0.3)" : "rgba(239, 68, 68, 0.3)",
              padding: "2rem",
              display: "flex",
          ...
          >
            ...
            >
              ...
              >
                {isSuccess ? (
                  <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="rgb(52, 211, 153)"
                       strokeWidth="2">
            ...
            <motion.button
              ...
              className={css({
                backgroundColor: isSuccess ? "rgb(52, 211, 153)" : "rgb(239, 68, 68)",
                color: "white",
                ...
                _hover: {
                  backgroundColor: isSuccess ? "rgb(41, 188, 136)" : "rgb(220, 38, 38)"
                }
              })}
            >
