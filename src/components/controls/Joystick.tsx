...
const JoystickComponents = (props: JoystickProps) => {
  ...
  const joystickDiv: HTMLDivElement = document.querySelector("#joystick");
...
const ButtonComponents = ({ buttonNumber = 1, ...props }: JoystickProps) => {
  /**
  ...
  const buttonDiv: HTMLDivElement = document.querySelector("#-button");
